...
matObj1 = matfile('Cyclopean_W1.mat');
matObj2 = matfile('Cyclopean_W2.mat');
...
for iPoint=1:330
    ...
    [ img_cropped, S ] = Crop_Saliency_Percentage(matObj1.Cyclopean_W1(:,:,:,iPoint),Saliency_3d_W1(:,:,iPoint),63,63,Sal_Value,100);        
...
for iPoint=1:460
    ...
    [ img_cropped, S ] = Crop_Saliency_Percentage(matObj2.Cyclopean_W2(:,:,:,iPoint),Saliency_3d_W2(:,:,iPoint),63,63,Sal_Value,100);        
    %Stock_img{iPoint} = [img_cropped(:,:,:,:)];
