...
for Sal_Value = [0.1:0.1:0.9]
   ...
   % clear Stock_img Stock_Dmos_new Stock_normdL2; % Clear for memory
    ...
    lgraph = removeLayers(lgraph, {'preprocessing'});
    lgraph = removeLayers(lgraph, {'pool5'});
    
    LLL=imageInputLayer([32 32 3],'Name','input_1');
    lgraph = addLayers(lgraph,LLL);
    lgraph = connectLayers(lgraph,'input_1','conv1');
    lgraph = connectLayers(lgraph,'res5b_relu','fc_1');
    ...
    lgraph = createLgraphUsingConnections(layers,connections);
        ...
        disp('Ruesults of Deep-Saliency LIVE II>>>');
