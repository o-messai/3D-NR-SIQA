...
for Sal_Value = [0.3:0.1:0.3]
   ...
   % clear Stock_img Stock_Dmos_new Stock_normdL2; % Clear for memory
    ...
    [FF_dmos_corr] = concatenate_data(FF_dmos,1);        clear FF_dmos;
        ...
        clearvars -except m k Performance Dmos_new Sal_Value Stock_normdL2 Stock_Dmos_new Stock_img Final_R Percentage index FINAL_score Average_R Saliency_vs_Score Models Dmos norm_dL2 Cyclopean_L2 Saliency_3d_L2 X Y
    end
